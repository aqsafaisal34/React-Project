...
https: var serviceAccount = {
  ...
  client_email:
    "firebase-adminsdk-xhvmu@e-commerce-c21d9.iam.gserviceaccount.com",
  client_id: "117232524921390836693",
  auth_uri: "https://accounts.google.com/o/oauth2/auth",
  token_uri: "https://oauth2.googleapis.com/token",
  auth_provider_x509_cert_url: "https://www.googleapis.com/oauth2/v1/certs",
  client_x509_cert_url:
    "https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-xhvmu%40e-commerce-c21d9.iam.gserviceaccount.com",
};
admin.initializeApp({
...
const dbURI =
  ...
  "mongodb+srv://abc:abc@cluster0.iunhwh0.mongodb.net/crudapp?retryWrites=true&w=majority";
...
app.post("/signup", upload.any(), (req, res) => {
  ...
  bucket.upload(
    req.files[0].path,
    {
      destination: `userImage/${req.files[0].filename}`, // give destination name if you want to give a certain name to file in bucket, include date to make name unique otherwise it will replace previous file with the same name
    },
    function (err, file, apiResponse) {
      if (!err) {
        // console.log("api resp: ", apiResponse);
